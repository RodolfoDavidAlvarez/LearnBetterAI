...
const Login = () => {
  const [email, setEmail] = useState(process.env.NODE_ENV !== "production" ? DEV_ADMIN.email : "");
  const [password, setPassword] = useState(process.env.NODE_ENV !== "production" ? DEV_ADMIN.password : "");
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          {process.env.NODE_ENV !== "production" && (
            <p className="mt-2 text-center text-sm text-yellow-600">Development Mode: Using pre-loaded admin credentials</p>
          )}
        </div>
