        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
              Please sign in or create an account to access the presentation and guide
            </p>
            <div className="flex justify-center gap-4">
              ...
              <button
                ...
                className="bg-white text-blue-600 border-2 border-blue-600 px-6 py-3 rounded-lg hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                Create Account
              </button>
            </div>
      ...
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="w-full max-w-6xl rounded-xl shadow-2xl overflow-hidden bg-white dark:bg-gray-800 p-4 transition-all duration-500">
              <iframe
